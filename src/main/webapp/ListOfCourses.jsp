...
<%@ page import="com.virtusa.coursemanagementsystem.dto.CourseDTO" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand mx-auto" href="#">UPYC</a>
                                ...
                                <div class="col-md-4">
                                    <div class="card mt-4">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-subtitle mb-2">Course ID: ${course.id}</h6>
                                            <p class="card-text">${course.description}</p>
                                            <!-- Button to navigate to another page -->
                                            <a href="another_page.jsp?id=${course.id}" class="btn btn-primary">Enroll Now</a>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
